  ...
  (() => {
    ...
    function _(e, t) {
      ...
      if (t) {
        var i = f({
          ...
          n = i.source,
          o = i.medium;
        if ("oauth" !== o && n !== e.source) return !1;
        var a = "cpc" === o,
          r = "cpc" === e.medium;
        if (a && !r) return !1;
      }
    ...
    function S() {
      ...
      try {
        ...
        try {
          r(e, "getPreviousSessionCount", n(y));
        } catch (t) {
          r(e, "getPreviousSessionCount", t);
        }
      }
    ...
    function C() {
      ...
      try {
        ...
        if (i) {
          var o = JSON.parse(i);
          !_(o, !t) || (t && o.id !== t.id) || (e = Math.max(e, o.depth));
        }
      } catch (e) {
        var a = null;
        try {
    ...
    const De = () =>
      ...
      Ve = "lcpgaTLqkd6gRi8AVtVr0gLe",
      He = "PIsUL8EJvXXA1thcFkCPWdhi",
      ...
      mt = "external";
    function ut() {
      return F.isPokiIframe || F.isPlayground ? (F.isPlayground ? pt : At) : mt;
    }
    const gt = {
      skyscraper: "160x600",
      rectangle: "300x250",
    ...
    function bt(e = "display") {
      return (
        !!F.forceStartAY ||
        F.AYMode === O.PBS_ONLY ||
        ([O.ON, O.PBS_DPF_CSTS].includes(F.AYMode) && ft())
      );
    }
    function yt() {
      return (
    ...
    async function xt() {
      ...
      (window.assertive = {
        ...
        (function () {
          try {
            if (
              ((vt = document.createElement("iframe")),
              (vt.id = "ay-video-optimizer"),
              vt.setAttribute("frameborder", "0"),
              vt.setAttribute("scrolling", "no"),
              vt.setAttribute("allowtransparency", "true"),
              vt.setAttribute("width", "1"),
              vt.setAttribute("height", "1"),
              (vt.style.position = "absolute"),
              (vt.style.left = "-9999px"),
              ...
              const e = vt.contentDocument.createElement("script");
              (e.textContent = `(${wt.toString()})();`),
                vt.contentDocument.body.appendChild(e);
            }
          } catch (e) {
        ...
        await X(
          "https://a.poki-cdn.com/ay/client-v2_f3c27e4cee6001972e13a7132858546453aa8b19.js"
        ),
        i &&
          (await X(
    ...
    function _t(e, t) {
      if (yt() && vt?.contentWindow?.floorModuleLoaded)
        try {
          return vt.contentWindow.assertive?.getAdServerFloorTargeting?.(e, t);
        } catch (e) {
          console.warn(
    ...
    function It(e, t, i, n, o) {
      let a = Pt("AdSystem", "Poki", { version: "0.1" });
      return (
        t &&
          (a += (function (e) {
    ...
    const Ot = (e) => {
      const { adId: t, adUnitCode: i, requestId: n, auctionId: o } = e,
        a = `poki_${Dt()}`;
      Lt.store(a, { adId: t, adUnitCode: i, requestId: n, auctionId: o });
      let { vastXml: r } = e;
      const { vastUrl: s } = e;
      return (
        r
          ? (r = Mt.getVastXmlWithTracking(r, a, void 0, void 0, void 0))
          : s && (r = Mt.buildVastWrapper(a, s, void 0, void 0, void 0)),
        (e.vastXml = r),
        a
      );
    };
              ...
              bids: [
                ...
                },
                {
                  ...
                  params: {
                    accountId: 18608,
                    siteId: 498726,
                    zoneId: e ? Ne[F.device].rewarded : Ne[F.device].midroll,
                    position: "atf",
                    video: { size_id: 204 },
                    bcat: zt,
                  },
                },
                {
                  ...
                  params: {
                    publisherId: "156838",
                    adSlot: e ? ze[F.device].rewarded : ze[F.device].midroll,
                    bcat: zt,
                  },
                },
                {
                ...
                },
                {
                  bidder: "amx",
                  params: {
                    tagId: e ? $e[F.device].rewarded : $e[F.device].midroll,
                    adUnitId: e ? Ke[F.device].rewarded : Ke[F.device].midroll,
                  },
                },
                {
                  bidder: "yieldmo",
                ...
                },
                {
                  ...
                  params: {
                    cid: "8CU2QB97K",
                    crid: e ? Ye[F.device].rewarded : Ye[F.device].midroll,
                  },
                },
                ...(bt("video")
                  ? [
                      ...
                      },
                      {
                        ...
                        params: {
                          pid: e ? ot[F.device].rewarded : ot[F.device].midroll,
                          supplyType: "site",
                        },
                      },
                      {
                      ...
                      },
                      {
                        ...
                        params: {
                          tagId: "yKyauEkOj",
                          adUnitId: e
                            ? `PBS_${Ke[F.device].rewarded}`
                            : `PBS_${Ke[F.device].midroll}`,
                        },
                      },
                      {
                        bidder: "yieldmo_s2s",
          ...
          s = [
            ...
            },
            {
              ...
              bids: [
                ...
                {
                  bidder: "sharethrough",
                  params: { pkey: Oe[F.device]["728x90"], bcat: zt },
                },
                {
                  bidder: "triplelift",
                ...
                },
                {
                  bidder: "amx",
                  params: {
                    tagId: $e[F.device]["728x90"],
                    adUnitId: Ke[F.device]["728x90"],
                  },
                },
                {
                  bidder: "yieldmo",
                ...
                {
                  bidder: "medianet",
                  params: { cid: "8CU2QB97K", crid: Ye[F.device]["728x90"] },
                },
                ...(bt()
                  ? [
                      {
                      ...
                      },
                      {
                        ...
                        params: {
                          pubId: "6da09f566a9dc06",
                          ext: { placement_name: at[F.device]["728x90"] },
                        },
                      },
                      {
                        bidder: "richaudience_s2s",
                        params: {
                          pid: ot[F.device]["728x90"],
                          supplyType: "site",
                        },
                      },
                      {
                        bidder: "sharethrough_s2s",
                        params: { pkey: et[F.device]["728x90"], bcat: zt },
                      },
                      {
                      ...
                      },
                      {
                        ...
                        params: {
                          tagId: "yKyauEkOj",
                          adUnitId: `PBS_${Ke[F.device]["728x90"]}`,
                        },
                      },
                      {
                        bidder: "yieldmo_s2s",
            ...
            },
            {
              ...
              bids: [
                ...
                {
                  bidder: "richaudience",
                  params: { pid: je[F.device]["300x250"], supplyType: "site" },
                },
                {
                  bidder: "sharethrough",
                  params: { pkey: Oe[F.device]["300x250"], bcat: zt },
                },
                {
                  bidder: "triplelift",
                ...
                },
                {
                  bidder: "amx",
                  params: {
                    tagId: $e[F.device]["300x250"],
                    adUnitId: Ke[F.device]["300x250"],
                  },
                },
                {
                  bidder: "yieldmo",
                ...
                {
                  bidder: "medianet",
                  params: { cid: "8CU2QB97K", crid: Ye[F.device]["300x250"] },
                },
                ...(bt()
                  ? [
                      {
                      ...
                      },
                      {
                        ...
                        params: {
                          pubId: "6da09f566a9dc06",
                          ext: { placement_name: at[F.device]["300x250"] },
                        },
                      },
                      {
                        bidder: "richaudience_s2s",
                        params: {
                          pid: ot[F.device]["300x250"],
                          supplyType: "site",
                        },
                      },
                      {
                        bidder: "sharethrough_s2s",
                        params: { pkey: et[F.device]["300x250"], bcat: zt },
                      },
                      {
                        bidder: "triplelift_s2s",
                      ...
                      },
                      {
                        ...
                        params: {
                          tagId: "yKyauEkOj",
                          adUnitId: `PBS_${Ke[F.device]["300x250"]}`,
                        },
                      },
                      {
                        bidder: "yieldmo_s2s",
            ...
            },
            {
              ...
              bids: [
                ...
                {
                  bidder: "richaudience",
                  params: { pid: je[F.device]["970x250"], supplyType: "site" },
                },
                {
                  bidder: "sharethrough",
                  params: { pkey: Oe[F.device]["970x250"], bcat: zt },
                },
                {
                  bidder: "triplelift",
                ...
                },
                {
                  bidder: "amx",
                  params: {
                    tagId: $e[F.device]["970x250"],
                    adUnitId: Ke[F.device]["970x250"],
                  },
                },
                {
                  bidder: "yieldmo",
                ...
                {
                  bidder: "medianet",
                  params: { cid: "8CU2QB97K", crid: Ye[F.device]["970x250"] },
                },
                ...(bt()
                  ? [
                      {
                      ...
                      },
                      {
                        ...
                        params: {
                          pubId: "6da09f566a9dc06",
                          ext: { placement_name: at[F.device]["970x250"] },
                        },
                      },
                      {
                        bidder: "richaudience_s2s",
                        params: {
                          pid: ot[F.device]["970x250"],
                          supplyType: "site",
                        },
                      },
                      {
                        bidder: "sharethrough_s2s",
                        params: { pkey: et[F.device]["970x250"], bcat: zt },
                      },
                      {
                        bidder: "triplelift_s2s",
                      ...
                      },
                      {
                        ...
                        params: {
                          tagId: "yKyauEkOj",
                          adUnitId: `PBS_${Ke[F.device]["970x250"]}`,
                        },
                      },
                      {
                        bidder: "yieldmo_s2s",
            ...
            },
            {
              ...
              bids: [
                ...
                {
                  bidder: "richaudience",
                  params: { pid: je[F.device]["160x600"], supplyType: "site" },
                },
                {
                  bidder: "sharethrough",
                  params: { pkey: Oe[F.device]["160x600"], bcat: zt },
                },
                {
                  bidder: "triplelift",
                ...
                },
                {
                  bidder: "amx",
                  params: {
                    tagId: $e[F.device]["160x600"],
                    adUnitId: Ke[F.device]["160x600"],
                  },
                },
                {
                  bidder: "yieldmo",
                ...
                {
                  bidder: "medianet",
                  params: { cid: "8CU2QB97K", crid: Ye[F.device]["160x600"] },
                },
                ...(bt()
                  ? [
                      {
                      ...
                      },
                      {
                        ...
                        params: {
                          pubId: "6da09f566a9dc06",
                          ext: { placement_name: at[F.device]["160x600"] },
                        },
                      },
                      {
                        bidder: "richaudience_s2s",
                        params: {
                          pid: ot[F.device]["160x600"],
                          supplyType: "site",
                        },
                      },
                      {
                        bidder: "sharethrough_s2s",
                        params: { pkey: et[F.device]["160x600"], bcat: zt },
                      },
                      {
                        bidder: "triplelift_s2s",
                      ...
                      },
                      {
                        ...
                        params: {
                          tagId: "yKyauEkOj",
                          adUnitId: `PBS_${Ke[F.device]["160x600"]}`,
                        },
                      },
                      {
                        bidder: "yieldmo_s2s",
            ...
            },
            {
              ...
              bids: [
                ...
                {
                  bidder: "sharethrough",
                  params: { pkey: Oe[F.device]["320x50"], bcat: zt },
                },
                {
                  bidder: "triplelift",
                ...
                },
                {
                  bidder: "amx",
                  params: {
                    tagId: $e[F.device]["320x50"],
                    adUnitId: Ke[F.device]["320x50"],
                  },
                },
                {
                  bidder: "yieldmo",
                ...
                {
                  bidder: "medianet",
                  params: { cid: "8CU2QB97K", crid: Ye[F.device]["320x50"] },
                },
                ...(bt()
                  ? [
                      {
                      ...
                      },
                      {
                        ...
                        params: {
                          pubId: "6da09f566a9dc06",
                          ext: { placement_name: at[F.device]["320x50"] },
                        },
                      },
                      {
                        bidder: "richaudience_s2s",
                        params: {
                          pid: ot[F.device]["320x50"],
                          supplyType: "site",
                        },
                      },
                      {
                        bidder: "sharethrough_s2s",
                        params: { pkey: et[F.device]["320x50"], bcat: zt },
                      },
                      {
                        bidder: "triplelift_s2s",
                      ...
                      },
                      {
                        ...
                        params: {
                          tagId: "yKyauEkOj",
                          adUnitId: `PBS_${Ke[F.device]["320x50"]}`,
                        },
                      },
                      {
                        bidder: "yieldmo_s2s",
            ...
            },
            {
              ...
              bids: [
                ...
                { bidder: "sharethrough", params: { pkey: Qe, bcat: zt } },
                {
                  bidder: "triplelift",
                ...
                },
                {
                  ...
                  params: {
                    tagId: "yKyauEkOj",
                    adUnitId: `${Ke[F.device]["728x90"]}_external`,
                  },
                },
                {
                  bidder: "yieldmo",
            ...
            },
            {
              ...
              bids: [
                ...
                },
                {
                  ...
                  params: {
                    tagId: "yKyauEkOj",
                    adUnitId: `${Ke[F.device]["300x250"]}_external`,
                  },
                },
                {
                  bidder: "yieldmo",
            ...
            },
            {
              ...
              bids: [
                ...
                { bidder: "sharethrough", params: { pkey: He, bcat: zt } },
                {
                  bidder: "triplelift",
                ...
                },
                {
                  ...
                  params: {
                    tagId: "yKyauEkOj",
                    adUnitId: `${Ke[F.device]["970x250"]}_external`,
                  },
                },
                {
                  bidder: "yieldmo",
            ...
            },
            {
              ...
              bids: [
                ...
                { bidder: "sharethrough", params: { pkey: Ve, bcat: zt } },
                {
                  bidder: "triplelift",
                ...
                },
                {
                  ...
                  params: {
                    tagId: "yKyauEkOj",
                    adUnitId: `${Ke[F.device]["160x600"]}_external`,
                  },
                },
                {
                  bidder: "yieldmo",
            ...
            },
            {
              ...
              bids: [
                ...
                },
                {
                  ...
                  params: {
                    tagId: "yKyauEkOj",
                    adUnitId: `${Ke[F.device]["320x50"]}_external`,
                  },
                },
                {
                  bidder: "yieldmo",
        ...
        Ht() &&
          window.pbjs.que.push(() => {
            const e = (function (e) {
                if (yt() && vt?.contentWindow?.floorModuleLoaded)
                  try {
                    return vt.contentWindow.assertive?.getPrebidFloor?.(e);
                  } catch (e) {
                    console.warn(
    ...
    let Yt = !1,
      Jt = !1,
      ei = null;
    const { testVideos: ti, device: ii } = F,
      ni = { log: () => {}, error: () => {}, warn: () => {}, info: () => {} },
      oi = () =>
        F.videoAdDebug?.breakVideoFlow
          ? "junk"
          : (ni.log("Getting ad unit path", {
              testVideos: ti,
              device: ii,
              siteID: F.siteID,
            }),
            ti
              ...
              : `/21682198607/${ii}_ingame_rewarded_google/${F.siteID}_${ii}_ingame_rewarded_google`),
      ai = () => {
        if (ei) return;
        if (((ei = Xt("poki-rewarded-web-iframe")), !ei)) return;
        const e = ei.contentWindow?.document;
        e &&
          (e.open(),
          e.write(
      ...
      ri = (t) => {
        ni.log("Starting backfill", { criteria: t }),
          ai(),
          te.track(e.tracking.ads.rewardedWeb.request),
          ((t) => {
            ni.log("Initializing rewarded slot", { criteria: t }),
              ei?.contentWindow
                ? (ei.contentWindow.postMessage(
                    {
                  ...
                  ni.log("Posted init message to iframe"),
                  setTimeout(() => {
                    Jt ||
                      (ni.log(
                ...
                : ni.log("No iframe content window available");
          })(t);
      },
      si = (e) => {
        ei &&
          ((ei.style.visibility = e ? "visible" : "hidden"),
          (ei.style.pointerEvents = e ? "auto" : "none"));
      };
    let di = !1,
      ci = null;
    const { testVideos: li, device: pi } = F,
        ...
        F.videoAdDebug?.breakVideoFlow
          ...
          : (Ai.log("Getting ad unit path", {
            ...
            li
              ...
              : `/21682198607/${pi}_ingame_interstitial_google/${F.siteID}_${pi}_ingame_interstitial_google`),
      ui = (e) => {
        ci &&
          ((ci.style.visibility = e ? "visible" : "hidden"),
          (ci.style.pointerEvents = e ? "auto" : "none"));
      },
      gi = () => {
        if (ci) return;
        if (((ci = Xt("poki-interstitial-web-iframe")), !ci)) return;
      ...
      hi = (t) => {
        Ai.log("Starting backfill", { criteria: t }),
          gi(),
          ((t) => {
            Ai.log("Initializing interstitial slot", { criteria: t }),
              ci?.contentWindow
      ...
      return (
        ...
        ("IN" === F.country.toUpperCase() ||
          ("mobile" === F.device &&
            ...
            (void 0 === bi &&
              ((bi =
                fi.includes(F.country.toUpperCase()) &&
                (function (e) {
                  let t = 0;
                  for (let i = 0; i < e.length; i++)
              ...
              te.track(e.tracking.ads.h5GamingEnabled, { enabled: bi })),
            bi)))
      );
    }
    class ki {
      ...
      startBackfill() {
        this.#l === e.ads.position.rewarded ? ri(this.#o) : hi(this.#o);
      }
      cutOffWaterfall() {
        ...
        Q.addVideoDataAnnotations({
          ...
          F.googlePreview
            ...
            ? (K(
              ...
              $t(this.#i, a, this.#o, this.#s, !0, this.#a))
            : yi()
            ? (this.timing.stopWaterfallTimer(),
              (this.#r = !1),
              this.startBackfill())
            ...
            ? (K(
              ...
              $t(this.#i, a, this.#o, this.#s, !1, this.#a))
            : (K(
    ...
    const _i = "pokiSdkContainer",
      Ii = "pokiSdkFixed",
      Si = "pokiSdkOverlay",
      Ei = "pokiSdkHidden",
      Ci = "pokiSdkInsideContainer",
      Pi = "pokiSdkPauseButtonContainer",
      Bi = "pokiSdkPauseButton",
      Ti = "pokiSdkPauseButtonBG",
      Di = "pokiSdkStartAdButton",
      Mi = "pokiSdkProgressBar",
      Li = "pokiSdkProgressContainer",
      Ri = "pokiSdkSpinnerContainer",
      Oi = "pokiSdkVideoContainer",
      Ni = "pokiSdkVisible",
      zi = "pokiSDKAdContainer",
      Ui = "pokiSDKHouseAdContainer",
      ji = "pokiSDKNrAdsContainer",
      Fi = `\n.${_i} {\n\toverflow: hidden;\n\tposition: absolute;\n\tleft: 0;\n\ttop: 0;\n\twidth: 100%;\n\theight: 100%;\n\tz-index: 99999;\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: center;\n}\n\n.${_i}.${Ii} {\n\tposition: fixed;\n}\n\n.${_i}.${Ni} {\n\tdisplay: block;\n}\n\n.${_i}.${Ei},\n.${Ri}.${Ei} {\n\tdisplay: none;\n}\n\n.${_i}.${Ei},\n.${Ri} {\n\tpointer-events: none;\n}\n\n.${Ri} {\n\tz-index: 10;\n\tposition: absolute;\n\ttop: 0;\n\tleft: 0;\n\twidth: 100%;\n\theight: 100%;\n\tbackground: url('https://a.poki-cdn.com/images/thumb_anim_2x.gif') 50% 50% no-repeat;\n\tuser-select: none;\n}\n\n.${Ci} {\n\tbackground: #000;\n\tposition: relative;\n\tz-index: 1;\n\twidth: 100%;\n\theight: 100%;\n\tdisplay: flex;\n\tflex-direction: column;\n\tjustify-content: center;\n\n\topacity: 0;\n\t-webkit-transition: opacity 0.5s ease-in-out;\n\t-moz-transition: opacity 0.5s ease-in-out;\n\t-ms-transition: opacity 0.5s ease-in-out;\n\t-o-transition: opacity 0.5s ease-in-out;\n\ttransition: opacity 0.5s ease-in-out;\n}\n\n.${_i}.${Ni} .${Ci} {\n\topacity: 1;\n}\n\n.${zi}, .${Oi} {\n\tposition: absolute;\n\twidth: 100%;\n\theight: 100%;\n}\n\n.${Di} {\n\tposition: absolute;\n\tz-index: 9999;\n\ttop: 0;\n\n\tpadding-top: 10%;\n\twidth: 100%;\n\theight: 100%;\n\ttext-align: center;\n\tcolor: #FFF;\n\n\tfont: 700 15pt 'Arial', sans-serif;\n\tfont-weight: bold;\n\tletter-spacing: 1px;\n\ttransition: 0.1s ease-in-out;\n\tline-height: 1em;\n}\n\n.${Pi} {\n\tcursor:pointer;\n\twidth: 100%;\n\theight: 100%;\n\tz-index: 10;\n}\n\n.${Ti} {\n    content: '';\n    background: rgba(0, 43, 80, 0.5);\n    display: block;\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n\tz-index: 11;\n}\n\n.${Pi}:hover .${Ti} {\n\tbackground: rgba(0, 43, 80, 0.7);\n}\n\n.${Bi} {\n\tposition: absolute;\n    top: 50%;\n    left: 50%;\n    z-index: 12;\n}\n\n.${Bi}:before {\n\tcontent: '';\n\tposition: absolute;\n\twidth: 100px;\n\theight: 100px;\n\tdisplay: block;\n\tborder: 2px solid #fff;\n\tborder-radius: 50%;\n\tuser-select: none;\n\tbackground-color: rgba(0, 0, 0, 0.6);\n\ttransition: background-color 0.5s ease;\n\tanimation: 1s linear infinite pokiPulse;\n\tz-index: 12;\n}\n\n.${Bi}:after {\n\tcontent: '';\n\tposition: absolute;\n\tdisplay: block;\n\tbox-sizing: border-box;\n\tborder-color: transparent transparent transparent #fff;\n\tborder-style: solid;\n\tborder-width: 26px 0 26px 40px;\n\tpointer-events: none;\n\tanimation: 1s linear infinite pokiPulse;\n\tleft: 6px;\n\tz-index: 12;\n}\n\n@keyframes pokiPulse {\n\t0% {\n\t\ttransform: translate(-50%, -50%) scale(0.95);\n\t}\n\t70% {\n\t\ttransform: translate(-50%, -50%) scale(1.1);\n\t}\n\t100% {\n\t\ttransform: translate(-50%, -50%) scale(0.95);\n\t}\n}\n\n.${Li} {\n\tbackground: #B8C7DD;\n\twidth: 100%;\n\theight: 5px;\n\tposition: absolute;\n\tbottom: 0;\n\tz-index: 9999;\n}\n\n.${Mi} {\n\tposition:relative;\n\tbottom:0px;\n\tbackground: #FFDC00;\n\theight: 100%;\n\twidth: 0%;\n\ttransition: width 0.5s;\n\ttransition-timing-function: linear;\n}\n\n.${Mi}.${Ni}, .${Pi}.${Ni}, .${Di}.${Ni} {\n\tdisplay: block;\n\tpointer-events: auto;\n}\n\n.${Mi}.${Ei}, .${Pi}.${Ei}, .${Di}.${Ei}, .${ji}.${Ei} {\n\tdisplay: none;\n\tpointer-events: none;\n}\n\n.${zi} .${Ui} {\n\tposition: absolute;\n\twidth: 100%;\n\theight: 100%;\n\tz-index: 99999;\n\tcursor: pointer;\n}\n\n.${ji} {\n\tbottom: 10px;\n\tposition: absolute;\n\tleft: 10px;\n\tz-index: 9999;\n\tcolor: #FFF;\n\tfont: 700 9pt 'Arial', sans-serif;\n\tfilter: drop-shadow(0 0 0.2rem black);\n}\n\n`;
    let Gi;
    async function Vi() {
      if (
        "undefined" != typeof navigator &&
        ...
        return !0;
      if (!Gi) {
        (Gi = document.createElement("video")),
          Gi.setAttribute("playsinline", "playsinline");
      ...
      try {
        return await Gi.play(), !0;
      } catch {
        return !1;
      }
    }
    function Hi(e) {
      e.classList.add(Ei), e.classList.remove(Ni);
    }
    function qi(e) {
      e.classList.add(Ni), e.classList.remove(Ei);
    }
    class Qi {
      #y;
      #k;
      ...
      constructor(t) {
        if (
          ((this.#M = new xi((e) => this.updateProgressBar(e))),
          this.#M.queueFakeProgress(20, 2e3, e.ads.started),
          this.#O(t.wrapper),
          "undefined" != typeof window && document)
        ) {
          const e = document.createElement("style");
          (e.innerHTML = Fi), document.head.appendChild(e);
        }
      }
      updateProgressBar(e) {
      ...
      async startNonIMAFallbackVideo(t) {
        ...
        Vi() || (i.muted = !0), i.play().catch(() => a());
      }
      setNrAds(e, t) {
        1 !== t
          ? (qi(this.#R), (this.#R.innerHTML = `Ad ${e} of ${t}`))
          : Hi(this.#R);
      }
    }
    class Wi {
          ...
          case google.ima.AdEvent.Type.IMPRESSION:
            Q.dispatchEvent(e.ads.impression, {
              ...
              (function () {
                ...
                vt?.contentWindow?.assertive?.logCustomImpression?.(p);
              })();
        }
      }
      onAdLoaderError(t) {
    ...
    async function Zi() {
      ...
      try {
        ...
        return (
          F.country &&
            ((o[F.country] = o[F.country] || {}),
            (o[F.country].video = o[F.country].video || {}),
            (o[F.country].video.triplelift = 0.05)),
          {
            blocklist: t?.split(/[\r\n]+/) || [],
    ...
    class Xi {
          ...
          window.googletag.pubads().addEventListener("slotRenderEnded", (t) => {
            ...
            try {
              ...
              (p = n.pbjsTargetting || {}),
                ...
                (u = ((e) => {
                  let t = { cpm: 0 };
                  if (void 0 === window.pbjs || !Ht()) return t;
      ...
      getDisplaySlotConfig(e, t, i, n = !1) {
        const o = t.split("x").map((e) => parseInt(e, 10)),
          a = this.getDisplaySlotID(e);
        if (a) {
          const t = this.slotMap.get(a);
          if (t && t.width === o[0] && t.height === o[1] && !n)
        ...
        return (
          ...
          (d.style.width = `${o[0]}px`),
          (d.style.height = `${o[1]}px`),
      ...
      renderAd(e) {
        const {
          ...
          m = this.getDisplaySlotConfig(t, i, a, A);
        ...
        a.includes("mobile_gamebar_320x50")
          ...
          : ((m.intersectionObserver = new window.IntersectionObserver(
              ([e]) => {
                e.isIntersecting && (m.intersectionObserver?.disconnect(), g());
              },
              { threshold: 0.5 }
            )),
      ...
      requestHouseAd = (t, i) => {
        ...
        W({ ...o, event: "request" }),
          ke(`https://api.poki.com/ads/houseads/display/${n}?site=${F.siteID}`)
            .then((e) => e.json())
            .then((a) => {
              o.creativeId = a.id;
              const r = `<img draggable="false" src="${a.asset}" alt="house ad" style="display:block; margin:0 auto;" />`;
              a.trigger_login
                ? ((t.innerAdContainer.innerHTML = `<div style="cursor: pointer;">${r}</div>`),
                  t.innerAdContainer.addEventListener("click", () => {
                    window?.top?.postMessage(
                      ...
                      W({ ...o, event: "trigger-login-click" });
                  }))
                : a.click_through_url
                ? ((t.innerAdContainer.innerHTML = `<a href="${a.click_through_url}" target="_blank" rel="noopener noreferrer">${r}</a>`),
                  t.innerAdContainer.addEventListener("click", () => {
                    W({ ...o, event: "click-through-url-click" });
                  }))
    ...
    class Yi extends Xi {
      requestAd = (e) => {
        ...
        Vt() || Ht() || ((e.pbjsTargetting = {}), (e.amznTargetting = {}), i());
      };
      allBidsBack(t) {
    ...
    const mn = (e, t) => {
        ...
        return null !== i && (i.constructor.name === t.name || mn(i, t));
      },
      un = new Set([
        "cx",
        "cy",
      ...
      gn = { html: void 0, svg: void 0 };
    function hn(e, t = {}) {
      const i = mn(e, SVGElement) ? "svg" : "html",
        n = gn[i];
      if (n) return n;
      const o =
          t.includeStyleProperties ??
          pn(window.getComputedStyle(document.documentElement)),
        a = "html" === i ? o.filter((e) => !un.has(e)) : [...o];
      return (gn[i] = a), a;
    }
    function wn(e, t) {
    ...
    function kn(e, t, i, n) {
      const o = `.${e}:${t}`,
        a = i.cssText
          ...
          : (function (e, t) {
              return hn(document.documentElement, t)
                .map(
                  (t) =>
    ...
    function xn(e, t, i, n) {
      ...
      s.appendChild(kn(r, i, o, n)), t.appendChild(s);
    }
    const _n = "application/font-woff",
      In = "image/jpeg",
      Sn = {
        woff: _n,
        woff2: _n,
    ...
    async function Mn(e, t) {
      return mn(e, HTMLCanvasElement)
        ? (async function (e) {
            try {
              if (e.getContext("2d")) return bn(e.toDataURL());
            } catch {}
            if (0 === e.width || 0 === e.height) return bn("data:,");
            const t = document
        ...
        ? (async function (e, t) {
            ...
            const { poster: i } = e,
              n = En(i);
            return bn(await Dn(i, n, t));
          })(e, t)
        : mn(e, HTMLIFrameElement)
        ? (async function (e, t) {
            try {
    ...
    const Ln = (e) => "SLOT" === e.tagName?.toUpperCase(),
      Rn = (e) => null != e.tagName && "SVG" === e.tagName.toUpperCase();
    function On(e, t, i) {
      return (
        (function (e, t, i) {
          const n = t.style;
        ...
        mn(t, HTMLElement) &&
        ((function (e, t) {
          mn(e, HTMLTextAreaElement) && (t.innerHTML = e.value),
            mn(e, HTMLInputElement) && t.setAttribute("value", e.value);
        })(e, t),
        (function (e, t) {
          if (mn(e, HTMLSelectElement)) {
            const i = t,
        ...
        (function (e, t, i) {
          xn(e, t, ":before", i), xn(e, t, ":after", i);
        })(e, t, i),
        i.patchScroll)
          ? (function (e, t) {
            ...
            Promise.resolve(e)
              ...
              .then((i) =>
                (async function (e, t, i) {
                  ...
                  return (
                    (n =
                      Ln(e) && e.assignedNodes
                        ? pn(e.assignedNodes())
                        : mn(e, HTMLIFrameElement) && e.contentDocument?.body
                        ? pn(e.contentDocument.body.childNodes)
                        : pn(
    ...
    async function Hn(e, t, i) {
      ...
      const n = (function (e, { preferredFontFormat: t }) {
        ...
        o = (function (e) {
          const t = [];
          return (
            e.replace(Un, (e, i, n) => (t.push(n), e)), t.filter((e) => !Cn(e))
          );
        })(n);
      return o.reduce(
        (e, n) => e.then((e) => Gn(e, n, t, i)),
        Promise.resolve(n)
      );
    }
    ...
    async function Qn(e, t) {
      An(e) &&
        (await (async function (e, t) {
          (await qn("background", e, t)) ||
            (await qn("background-image", e, t)),
            (await qn("mask", e, t)) || (await qn("mask-image", e, t));
        })(e, t),
        await (async function (e, t) {
          const i = mn(e, HTMLImageElement),
            n = mn(e, SVGImageElement);
          if ((!i || Cn(e.src)) && (!n || Cn(e.href.baseVal))) return;
        ...
        await (async function (e, t) {
          const i = pn(e.childNodes).map((e) => Qn(e, t));
    ...
    async function Kn(e) {
      ...
      return (t = { url: e, cssText: await i.text() }), (Wn[e] = t), t;
    }
    ...
    async function Xn(e, t) {
      ...
      const i = pn(e.ownerDocument.styleSheets),
      ...
      return (function (e) {
        return e
          ...
          .filter((e) => Vn(e.style.getPropertyValue("src")));
      })(n);
    }
    ...
    async function eo(e, t = {}) {
      ...
      return (
        ...
        t.skipAutoScale ||
          (function (e) {
            (e.width > fn || e.height > fn) &&
              (e.width > fn && e.height > fn
                ? e.width > e.height
                  ? ((e.height *= fn / e.width), (e.width = fn))
                  : ((e.width *= fn / e.height), (e.height = fn))
                : e.width > fn
                ? ((e.height *= fn / e.width), (e.width = fn))
                : ((e.width *= fn / e.height), (e.height = fn)));
          })(r),
    ...
    const ro = [],
      ...
      co = console.error,
      lo = ["Audio callback had starved sending audio by"];
    let po = !1;
    const Ao = Math.random().toString(36).substring(2);
    let mo;
    function uo() {
      const e = window;
    ...
    function go(e, t = !0) {
      F.gameID && !F.isPlayground
        ? so((t) => {
            try {
              const i = e.message || no(e);
              ro.push({ n: e.name, m: i, s: JSON.stringify(e.stack) }),
                mo && mo({ name: e.name, message: i, stack: e.stack });
              ...
              co("%cPOKI:%c failed to log error", "font-weight: bold", "", e);
            }
          })
        : t &&
    ...
    function ho(e) {
      io(e.reason)
        ...
        : go({
            ...
            message: JSON.stringify(e.reason) || no(e),
          });
    }
    function wo(e) {
      io(e.error) ? go(e.error) : go(e);
    }
    function vo() {
      if (
        F.gameID &&
        ...
        (po = !0),
          window.addEventListener("unhandledrejection", ho),
          window.addEventListener("error", wo);
        try {
          console.error = (...e) => {
            const t = no(e);
            lo.some((e) => t.includes(e)) ||
              go({ name: "console.error", message: t }, !1),
              co.apply(console, e);
          };
        } catch {}
      }
    ...
    function fo() {
      if (po) {
        (po = !1),
          window.removeEventListener("unhandledrejection", ho),
          window.removeEventListener("error", wo);
        try {
          console.error = co;
        } catch {}
      }
    }
    "undefined" != typeof window && vo();
    const bo = async (e) => {
    ...
    const Bo = "Game tab in background";
    let To = !0,
      Do = [],
      Mo = null,
      ...
      Vo = 24;
    (M() || L() || he) && (Vo = 12),
      Lo.setAttribute("data-poki-no-playtest", "true"),
      Lo.addEventListener("webglcontextlost", () => {
        console.info(
    ...
    let qo = !1,
      ...
      Jo = -1;
    function ea(e) {
      if (null === Mo || !Do.length) return;
      const t = Do[0],
        i = t.width / Mo.width,
        n = t.height / Mo.height,
        o = (e.clientX - Mo.left) * i,
        a = (e.clientY - Mo.top) * n;
      (Ho.x = Math.max(0, Math.min(o, t.width))),
        (Ho.y = Math.max(0, Math.min(a, t.height)));
    }
    const ta = (e) => {
        Do.length && Lo && ea(e);
      },
      ia = (e) => {
        Do.length &&
          ...
          (0 === e.button
            ...
            : 2 === e.button
            ? ((Wo = !0), (Ko = !1))
            : 1 === e.button && ((qo = !0), (Qo = !1), (Wo = !0), (Ko = !1)),
          ea(e));
      },
      na = (e) => {
        0 === e.button
    ...
    function oa() {
      ...
      e &&
        Lo &&
        Ro &&
        ((Ro.fillStyle = "rgba(255, 255, 255, 0.5)"),
        Ro.fillRect(0, 0, Lo.width, Lo.height),
        (Ro.font = "48px Arial"),
        (Ro.fillStyle = "#009cff"),
        (Ro.textAlign = "center"),
        Ro.fillText(e, Lo.width / 2, Lo.height / 2));
    }
    function aa(e) {
      if (!Lo || !Do.length) return;
      const t = Do[0],
        i = t.width,
        n = t.height;
      if (i === Yo && n === Jo && !e) return;
      (Yo = i), (Jo = n), (Mo = t.getBoundingClientRect());
      let { width: o, height: a } = Mo;
      (0 !== o && 0 !== a) || ((o = i), (a = n));
      const r = M() || L(),
    ...
    async function sa(e) {
      if (
        ...
        (Oo ||
          ...
          0 === Do.length
            ? ((Oo.width = Lo.width), (Oo.height = Lo.height))
            : ((Oo.width = Do[0].width), (Oo.height = Do[0].height)),
          Oo.addEventListener("contextlost", () => {
            (Oo = null), (No = null);
          })),
        No || ((No = Oo.getContext("2d")), No))
      )
        try {
          performance.now();
          ...
          if (t && t.length > 10) {
            ...
            requestAnimationFrame(() => {
              Oo &&
                No &&
                (No.clearRect(0, 0, Oo.width, Oo.height),
                No.drawImage(
                  e,
                  0,
                  0,
    ...
    async function ca(e) {
      if (!To) {
        Do = e;
        for (let e = 0; e < Uo.length; e++) Uo[e].stop();
        for (let e = 0; e < jo.length; e++) jo[e].readable.cancel();
        for (let e = 0; e < Fo.length; e++) Fo[e].cancel();
        for (let e = 0; e < Go.length; e++) Go[e].close();
        (Uo = []), (jo = []), (Fo = []), (Go = []);
        try {
          if (we)
            for (let e = 0; e < Do.length; e++) {
              if (Do[e].pokiHtmlDummyCanvas) continue;
              const t = Do[e].captureStream(Vo).getVideoTracks()[0];
              Uo.push(t), Go.push(null);
              const i = new Blob(
                  [
            ...
            for (let e = 0; e < Do.length; e++) {
              ...
              Uo.push(t), jo.push(i), Fo.push(n), Go.push(null);
              const o = () => {
    ...
    function pa(e, t) {
      if (!Lo) return null;
      (To = !1), ca(e), aa(!0);
      const i = Lo.captureStream(Vo);
      let n;
      window.addEventListener("pointermove", ta, { capture: !0, passive: !0 }),
        window.addEventListener("pointerdown", ia, {
          capture: !0,
          passive: !0,
        }),
        window.addEventListener("pointerup", na, { capture: !0, passive: !0 }),
        window.addEventListener("contextmenu", na, {
          capture: !0,
          passive: !0,
        });
      let o,
      ...
      if (s === tn || s === en) {
        ...
        n = setInterval(() => {
          if (!Lo) return;
          const t = !!Do[0].pokiHtmlDummyCanvas;
          !t ||
            (Do[0].width === window.innerWidth &&
              Do[0].height === window.innerHeight) ||
            ((Do[0].width = window.innerWidth),
            (Do[0].height = window.innerHeight));
          let i = !1;
          if (
        ...
        (o = setInterval(() => {
          if (To || !Lo || !Do.length || a > 10)
            return (
              ...
              window.removeEventListener("pointermove", ta),
              window.removeEventListener("pointerdown", ia),
              window.removeEventListener("pointerup", na),
              window.removeEventListener("contextmenu", na),
              clearInterval(n),
              cn(""),
              (Lo = null),
              (Ro = null),
          ...
          e === Ji
            ? (cn(""), sa(!1))
            : e === nn && (cn(""), (Oo = null), (No = null)),
            Ro.clearRect(0, 0, Lo.width, Lo.height);
    ...
    function Aa() {
      ...
      e?.removeEventListener("pointerdown", Aa),
        t?.removeEventListener("pointerdown", Aa),
    ...
    function ua({ gameTitle: e, rejectCallback: t, resolveCallback: i }) {
            ...
            (function ({ rejectCallback: e, resolveCallback: t }) {
              ...
              o &&
                [
                  ...
                  "contextmenu",
                  "dragstart",
                ].forEach((e) => o.addEventListener(e, ma));
            })({ rejectCallback: t, resolveCallback: i });
        });
    }
    const ga = window.requestAnimationFrame;
    function ha(e) {
    ...
    class wa {
      ...
      stats() {
        ...
        const e = Math.min(...this.#G),
          t = Math.max(...this.#G),
          i = ha(this.#G.reduce((e, t) => e + t, 0) / this.#G.length);
        let n = ha(
          this.#G
            .slice(1)
    ...
    const _a = window.requestAnimationFrame;
    function Ia(e) {
      ...
      window.addEventListener("beforeunload", () => {
        ...
        (s = []),
          ...
          Ia({
            ...
            total_duration: c,
            timed_out: !0,
            sdk_version: "e0a5a05d5366b59f6c17064c325d0eb81a6556d4",
            fpss: d,
            upvotes: o,
            downvotes: a,
            have_interaction: xa() > 0,
          });
      });
      window.addEventListener("message", (e) => {
        e.data &&
    ...
    try {
      const e = (e) => {
        ...
        (console[e] = (...i) => {
          t.apply(console, i),
            Oa &&
              Oa.push({ timeMs: performance.now(), level: e, message: va(i) });
        }),
          Ra.push(() => {
            console[e] = t;
          });
    ...
    function Na() {
      (Ba = null), Ra.forEach((e) => e()), (Ra = []), (Oa = null);
    }
    function za(t, i, n) {
      console.info(
      ...
      const o = pa(t, () => {
        Ta?.close(1e3, "Playtest recording stopped");
      });
      o &&
        ((Ta = new WebSocket("wss://playtest-recorder.poki.io/ws")),
        Ta.addEventListener("error", () => {
        ...
        Ta.addEventListener("open", () => {
          ...
          (Pa = (e, t) => {
            if (!Ta || Ta.readyState !== Ta.OPEN) return;
            Ta.send(no({ type: "sdk-event", offset: s(t), event: e }));
            const i = La[e];
            i &&
              Ta.send(
                no({
    ...
    !(function (e) {
      ...
      if (
        ...
        try {
          Pa(t.event),
            null !== Ba &&
              Ba.push({ event: t.event, timeMs: performance.now() });
        } catch (e) {
    ...
    function Ua(t) {
      const i = (function (e) {
          ...
          if (e.playtestNewUser && Ca) return !1;
          const t = M() || L() || he;
        ...
        te.track(e.tracking.playtest.showModal, { show: !0 }),
          ...
          new Promise((e, t) => {
            console.info(
              ...
              ua({ rejectCallback: t, resolveCallback: e, gameTitle: a });
          }))
            .then(() => {
    ...
    function Ha() {
      window.navigator.userAgent.match(Va) &&
        !F.isPlayground &&
    ...
    const $a = class {
        ...
        init = (t = {}) => {
          ...
          t[Ka] &&
            t[Ka]((t, i) => {
              !(async function (t, i) {
                const n = { time_on_page: performance.now() };
                if (
                  "74b97156-f40b-11e9-859c-c6053849a814" === F.gameID &&
                  i > Wa
                ) {
                  const e = await ko();
                  e && ((n.screenshot = e), (Wa = i));
                }
                G.sendMessage(e.message.sendScore, {
                  data: { leaderboard: t, score: i, meta: n },
                });
              })(t, i);
            }),
            ...
            (this.#re = new Promise((i) => {
              this.__monetization.init({
                ...
                G.sendMessage(e.message.sdkDetails, {
                  version: "e0a5a05d5366b59f6c17064c325d0eb81a6556d4",
                });
            })),
            this.#re
          );
              ...
              if ("pokiGenerateScreenshot" === t.data.type)
                (async (t) => {
                  ...
                  if (i) {
                    ...
                    n = await ko({ title: e, thumbnail: i });
                  } else n = await ko();
                  const o = { screenshot: n, errors: ro };
        ...
        setDebug = (t = !0) => {
          ...
          i.endsWith("poki-gdn.com")
            ...
            : ((V.debug = t), (V.log = t ?? V.log), t ? fo() : vo());
        };
        setLogging = (e) => {
        ...
        gameplayStart = (t) => {
          ...
          setTimeout(() => {
            let n;
            performance.now() - xa() < 5e3 && (n = this.#J),
        ...
        openExternalLink = (t) => {
          this.__logCall("openExternalLink", t),
            G.sendMessage(e.message.openExternalLink, { params: { url: t } });
        };
        customEvent = (t, i, n = {}) => {
            ...
            this.__runVideoAd({
              ...
              onStart: () => {
                if (
                  (this.#ie++,
                  window.pokiMeasureBuildin &&
                    window.PokiSDK.measure("midroll", this.#ie),
                  "function" == typeof t)
                )
                  try {
                    t();
              ...
              this.__runVideoAd({
                ...
                onStart: () => {
                  if (
                    (this.#ne++,
                    window.pokiMeasureBuildin &&
                      window.PokiSDK.measure("rewarded", this.#ne),
                    "function" == typeof n)
                  )
                    try {
                      n();
        ...
        playtestSetCanvas = (e) => {
          if ((this.__logCall("playtestSetCanvas", e), !e)) return void sn([]);
          const t = [].concat(e);
          sn(t), ca(t);
        };
        playtestCaptureHtmlOnce = () => {
          this.__logCall("playtestCaptureHtmlOnce"), cn(Ji);
        };
        playtestCaptureHtmlForce = () => {
          this.__logCall("playtestCaptureHtmlForce"), cn(en);
        };
        playtestCaptureHtmlOn = () => {
          this.__logCall("playtestCaptureHtmlOn"), cn(tn);
        };
        playtestCaptureHtmlOff = () => {
          this.__logCall("playtestCaptureHtmlOff"), cn(nn);
        };
          ...
          new Promise((r) => {
            ...
            Q.clearVideoDataAnnotations(),
              ...
              this.__monetization.requestAd({
                ...
                onStart: () => {
                  if (
                    (this.__monetization.setNrAds(s, i), "function" == typeof n)
                  )
                    try {
                      n();
                    } catch (e) {
        ...
        new (class {
          ...
          constructor() {
            (window.googletag = window.googletag || { cmd: [] }),
              ...
              (this.display = Zt() ? new Yi() : new Xi());
          }
          init(e = {}) {
            if ("undefined" == typeof window) return;
            const { onReady: t = null } = e;
            if (((this.#ke = e), t && this.#Le("onReady", t), !this.#ve))
              return (
                this.#he ||
          ...
          configureA9 = (e) => qt(e, this.#xe.bidderLimitation);
          #Re() {
                ...
                .then((r) => {
                  try {
                    ...
                    "rejected" === s.status && (this.#De = !0),
                      ...
                      qt(i, this.#xe.bidderLimitation),
                      (() => {
                        ni.log("Loading rewarded web"),
                          ei?.contentWindow ||
                            (ai(),
                            ni.log("No iframe content window available"));
                        let t = 0;
                          ...
                          if (i.data?.type)
                            switch (i.data.type) {
                              ...
                              case "rewardedSlotGranted":
                                ni.log("Received reward granted from iframe"),
                                  (Yt = !0);
                                break;
                              case "rewardedSlotClosed":
                                ni.log("Received slot closed from iframe", {
                                  grantReward: Yt,
                                }),
                                  si(!1),
                                  Yt
                              ...
                              case "rewardedSlotRequested":
                                ni.log("Received slot requested from iframe", {
                                  hasEvent: i.data,
                                }),
                                  i.data.hasEvent ||
                                    (te.track(e.tracking.ads.rewardedWeb.empty),
                    ...
                    if (
                      ...
                      this.#ye && ja.startStartAdsAfterTimer(),
                      (this.#fe = new ki(this.#i, {
                        timing: ja,
                        totalRetries: o,
                      })),
                      (this.#Te = !0),
          ...
          requestAd(t = {}) {
            ...
            if (!F.adOverrideMode) {
              if (a === e.ads.position.preroll && !ja.prerollPossible() && !r)
                return (
              ...
              if (a !== e.ads.position.rewarded && !ja.requestPossible())
                return (
            ...
            if (ue())
              return (
                Z("No USP detected!"), void Q.dispatchEvent(e.ads.error, s)
              );
            if (this.#Ee) return void Q.dispatchEvent(e.ads.ready, s);
            const d = {
              ...this.#je(),
              ...this.#o,
              position: a,
          ...
          startStartAdsAfterTimer() {
            this.#ze() ? (this.#ye = !0) : ja.startStartAdsAfterTimer();
          }
          muteAd() {
          ...
          forcePreroll() {
            if (this.#ze()) return;
            const t = ja.prerollPossible;
            (ja.prerollPossible = () => !0),
              this.requestAd({ position: e.ads.position.preroll }),
              (ja.prerollPossible = t);
          }
          resumeAd() {
            ...
            this.#we.hide(),
              ...
              this.#ze() ||
                ...
                this.#Ie.position === e.ads.position.rewarded
                  ? (ni.log("Destroying rewarded web", new Error().stack),
                    ei &&
                      (ei.remove(),
                      (ei = null),
                      ni.log("Iframe removed"),
                      (Jt = !1),
                      (Yt = !1)))
                  : (Ai.log("Destroying interstitial web", new Error().stack),
                    ci &&
                      (ci.remove(),
                      (ci = null),
    ...
    for (const e in Za) e.startsWith("__") || (window.PokiSDK[e] = Za[e]);
  })();
})();
